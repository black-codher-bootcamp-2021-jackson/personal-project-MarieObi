...
// building out the playlists section
const PlaylistsGrid = ({ playlists }) => (
  <>
    {playlists && playlists.length ? (
      <ul className ="StyledGrid">
        {playlists.map((playlist, i) => (
          <li className="grid__item" key={i}>
            {/* this component uses React Router's <Link> component to wrap each playlist item in a link to its individual playlist page */}
